...
router.delete('/:id', auth, async (req, res) => {
    ...
    try {
        ...
        console.log('  Admin ID:', group.adminId, '| Current User:', req.user.id);
        ...
        // Use raw query to delete from junction table
        try {
            console.log('Removing members from UserGroups table...');
            ...
            console.log('⚠️ Error removing members (continuing):', memberErr.message);
        }

        // Delete the group
        console.log('Deleting group from database...');
        await group.destroy();
